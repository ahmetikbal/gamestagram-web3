...
/// Service for managing game data and providing game-related functionality
/// Currently uses a predefined list of web games for demonstration
class GameService {
  final Random _random = Random();

  /// Predefined collection of web-based games with their metadata
  /// Each game includes title, description, URL, genre, and image
  ...
  /// Fetches a subset of games with simulated network delay
  /// Returns up to [count] games from the predefined collection
  Future<List<GameModel>> fetchGames({int count = 5}) async {
    ...
    // Return requested number of games or all available games if count exceeds collection size
  ...
  // Future methods for potential expansion:
