...
class SocialService {
  ...
  Future<List<InteractionModel>> getComments(String gameId, {int limit = 20}) async {
    try {
      ...
      print('[SocialService] Error getting comments: $e');
      return [];
    }
  }
  ...
  Future<int> getLikeCount(String gameId) async {
    try {
      ...
      print('[SocialService] Error getting like count: $e');
      return 0;
    }
  }
  ...
  Future<int> getCommentCount(String gameId) async {
    try {
      ...
      print('[SocialService] Error getting comment count: $e');
      return 0;
    }
  }
  ...
  Future<int> getUserLikeCount(String userId) async {
    try {
      ...
      print('[SocialService] Error getting user like count: $e');
      return 0;
    }
  }
  ...
  Future<int> getUserCommentCount(String userId) async {
    try {
      ...
      print('[SocialService] Error getting user comment count: $e');
      return 0;
    }
  }
  ...
  Future<void> preloadComments(List<String> gameIds) async {
    ...
    print('[SocialService] Preloading comments for ${gameIds.length} games');
  }
}
